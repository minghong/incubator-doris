...
public abstract class PlanVisitor<R, C> implements CommandVisitor<R, C>, RelationVisitor<R, C>, SinkVisitor<R, C> {
    ...
    public R visitPhysicalLazyMaterializeFileScan(PhysicalLazyMaterializeFileScan<? extends Plan> scan, C context) {
        return visit(scan, context);
    }

    public R visitPhysicalLazyMaterializeOlapScan(PhysicalLazyMaterializeOlapScan<? extends Plan> scan, C context) {
        return visit(scan, context);
    }
