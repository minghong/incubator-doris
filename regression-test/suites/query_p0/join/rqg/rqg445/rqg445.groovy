...
set enable_fallback_to_original_planner=false;
    ...
    order_qt_445 """
    SELECT
    tbl5.col_int_undef_signed2 AS col_int_undef_signed,
    tbl2.col_int_undef_signed4 AS col_int_undef_signed2,
    tbl5.col_int_undef_signed4 AS col_int_undef_signed3,
    5 AS col_int_undef_signed4
FROM
    table_200_undef_partitions2_keys3_properties4_distributed_by5 AS tbl1
    INNER JOIN table_30_undef_partitions2_keys3_properties4_distributed_by52 AS tbl2 ON tbl2.col_int_undef_signed3 = tbl1.col_int_undef_signed4
    OR tbl1.col_int_undef_signed = tbl2.col_int_undef_signed
    INNER JOIN table_200_undef_partitions2_keys3_properties4_distributed_by52 AS tbl3 ON tbl3.col_int_undef_signed = tbl3.col_int_undef_signed3
    JOIN table_50_undef_partitions2_keys3_properties4_distributed_by5 AS tbl4 ON tbl4.col_int_undef_signed3 != tbl4.col_int_undef_signed2
    INNER JOIN table_30_undef_partitions2_keys3_properties4_distributed_by52 AS tbl5 ON tbl4.col_int_undef_signed4 = tbl5.col_int_undef_signed4
    AND tbl3.col_int_undef_signed4 = tbl3.col_int_undef_signed3
WHERE
    NOT (
        tbl2.col_int_undef_signed4 < tbl3.col_int_undef_signed3
    )
ORDER BY
    1,
    2,
